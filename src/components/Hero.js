...
import icon_whatapp from '../assets/images/whatapp.svg'
    ...
    return (
      <section className='hero'>
            <div className='hero__text'>
                ...
                <p className='hero__text__subtitle'>Os médicos da DoctorCare vão além dos sintomas para tratar a causa raiz de sua doença e proporcionar uma cura a longo prazo.</p>
